...
class Pubs(object):
    ...
    def set_data(self, path, value={}, pub=None):
        ...
        Args:
            ...
            pub (None, optional): rclpy.Publisher
        """
    ...
    def publish_topic(self, topic, msg_type, queue=1):
        ...
        """
        self.set_data(topic, pub=self.node.create_publisher(
                msg_type, topic, queue))
    ...
    def publish_topics(self):
        ...
        for topic, msg_type, queue in self.topics:
            self.publish_topic(topic, msg_type, queue)
...
if __name__ == '__main__':
    try:
        rclpy.init('set_mav_data')
    except rclpy.ROSInterruptException as error:
        print('pubs error with ROS: ', error)

    pub = Pubs()
    pub.publish_topic('/mavros/rc/override', mavros_msgs.msg.OverrideRCIn)
